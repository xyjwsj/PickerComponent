...
@implementation UICommonPickerViewController {
...
- (void)setToolBar {
    ...
    UIButton* cancleBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 40, 30)];
    ...
    sureBtn.x = toolBarView.frame.size.width - BAR_BTN_LRSPACE - sureBtn.frame.size.width;
